...
//                        masukkan ke variabel responseText dengan pemisah tanda tagar #
                ...
                if (gejalaTerpilih.toString().equals("")) {
                    Toast.makeText(KonsultasiActivity.this, "Silakan pilih gejala!", Toast.LENGTH_SHORT).show();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.name.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton checkboxView, boolean isChecked) {
                    ...
                    if(globalInc >= 4) {
                        Toast.makeText(getContext(), "Maaf Maksimal 3 Pilihan Saja", Toast.LENGTH_LONG).show();
